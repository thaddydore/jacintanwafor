      ...
      <main className="w-full">
          ...
          <div className="relative max-w-[790px]">
            ...
            <div className="text-start">
              <p className="md:text-[60px] text-3xl md:leading-[86px] relative md:max-w-[781px] text-start">
                Hello! I love designing <span className="font-bold">digital products</span> that solve <span className="font-bold">user problems</span> while meeting{" "}
                <span className="font-bold">business goals. </span>
              </p>
            </div>
          </div>
          <p className="md:pt-10 pt-5 md:text-xl text-sm text-[#454545]">Currently a Product Designer in Cyberspace, Lagos Nigeria </p>
        </section>
        ...
        <section className="section bg-[#141617] ">
          <div className="text-center flex justify-center text-sm text-[#E6E6E6] md:gap-6 gap-2">
            ...
            <Link to="https://drive.google.com/file/d/14OvCGU2F2y7YWg7OsyTW-ZzZkI7k8i6X/view?usp=sharing" target="_blank">
              Resume
            </Link>
          </div>
          ...
          <div className="flex justify-between items-center font-medium text-xs text-[#787878] mt-7 md:flex-row flex-col">
            ...
            <p>
              Designed by{" "}
              <Link to={"https://www.linkedin.com/in/jacintachianumba"} target="_blank" className="text-xs text-[#787878] font-bold">
                Jacinta
              </Link>
              , built by{" "}
              <Link to="https://github.com/OwoeyeMoyosore" target="_blank" className="text-xs text-[#787878] font-bold">
                Owoeye Moyosore
              </Link>
            </p>
          </div>
