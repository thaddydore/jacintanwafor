			...
			<section className='pt-28 pb-40'>
				...
				<section className='screen300'>
					<p className='text-[#454545] text-base'>
						{' '}
						<span className='font-semibold'>Mobile design enhancement for zenith bank</span> is one of my projects
						as a product designer in <span className='font-semibold'> Cyberspace,</span> which leverages on
						technology to provide investment services.{' '}
					</p>

					<div className='pt-20'>
						<h1 className='text-[#5E9825] text-[26px] font-semibold leading-[36px] text-left'>INTRODUCTION</h1>
						<dd className='introduction'>
							Quantum Zenith is a premier offering from Zenith Bank, dedicated to tracking, managing, and
							enhancing investments. The focus is achieving returns above inflation rates through strategic
							investments in fixed-grade income securities.
						</dd>
					</div>
					...
					<div className='pt-28 flex lg:flex-row flex-col lg:gap-[70px] w-full pb-16'>
						<div className='md:w-5/6'>
							...
							<dd className='text-base text-[#454545] pt-4'>
								I ensured that the user experience is intuitive, seamless, and visually appealing. I focus on
								crafting user interfaces that are easy to navigate, understand, and interact with, making the
								investment management process effortless for our users. From designing the layout and flow of
								the platform to creating visually engaging elements, my aim is to enhance user satisfaction and
