		...
		<main className='bg-white'>
			...
			<section className='screen300'>
				<p className='text-[#454545] text-base'>
					{' '}
					<span className='font-semibold'>Revealing vital information about vehicles with just VIN</span> is one of
					my projects as a product designer in
				...
				<div className='pt-20'>
					...
					<dd className='introduction'>
						VIN check is a web-based application that enables vehicle owners to know detailed history of any
						vehicle. This enhances decision making while purchasing, repairing and maintaining any vehicle.
						<br />
						<br />
						Vehicle Identification Number (VIN) is a 17-character sequence of numbers and letters that{' '}
						<span className='font-semibold'>uniquely identifies a vehicle.</span> The VIN gives a detailed report
						on the{' '}
						<span className='font-semibold'>unique features, specifications, and manufacturer of a vehicle,</span>{' '}
						and also tracks the usage record.
					</dd>
				</div>
					...
					<div className='md:w-5/6 flex flex-col md:gap-10 gap-5 w-full'>
						<div>
							...
							<dd className='text-base text-[#454545] pt-4'>
								As the only product designer on this project, my responsibilities include working with
								stakeholders to get requirements, communicating with developers on project feasibility, leading
								the end-to-end design process, and meeting expectations.
							</dd>
						</div>
						<div>
							...
							<dd className='text-base text-[#454545] pt-4 flex gap-2 items-start'>
								...
								<span>
									Improving VIN report purchases by easing payment and putting users location into
									consideration .{' '}
								</span>
							</dd>
							<dd className='text-base text-[#454545] pt-4 flex gap-2 items-start'>
								...
								<span>
									Ensuring a snippet of the report is displayed before purchase, and the information gotten is
									accurate.{' '}
								</span>
							</dd>
							<dd className='text-base text-[#454545] pt-4 flex gap-2 items-start'>
			...
			<section className='xl:px-[200px] md:py-20 py-6 px-10 md:px-32 rounded-lg '>
				<div className='bg-[#FAFAFA] xl:px-[100px] md:px-10 px-4 md:pt-20 pt-10 flex flex-col md:gap-40 gap-10'>
					<div>
						<h1 className='text-center text-xl font-semibold text-[#F22E5D]'>
							1. DESIGNING ACCESS TO VIN REPORT
						</h1>
						<p className='introduction md:text-center'>
							This web app redesign means vehicle owners can{' '}
							<span className='font-bold'>access vehicle history report</span> from all countries across Nigeria
							and globally with just VIN. Before purchase, a sample report can be viewed to confirm that it meets
						...
						<div className='flex md:flex-row flex-col gap-7'>
							<div
								className='font-medium text-[#787878] text-sm flex md:flex-col flex-col-reverse gap-4'
								data-aos='fade-up'
					...
					<div className='flex md:flex-col flex-col-reverse gap-4'>
						...
						<p className='font-medium text-[#787878] text-sm text-center'>
							Multiple alternatives of locating the VIN in any vehicle with graphical explanation
						</p>
					</div>
					...
					<div data-aos='fade-up' data-aos-duration='2000' className='flex md:flex-col flex-col-reverse gap-4'>
						...
						<p className='font-medium text-[#787878] text-sm text-center'>
							Designing for all possible states, including incorrect VIN and for returning users
						</p>
					</div>
					...
					<div className='flex md:flex-col flex-col-reverse gap-4'>
						...
						<p className='font-medium text-[#787878] text-sm text-center'>
							What VIN report contains is clearly listed
						</p>
					</div>
					...
					<div data-aos='fade-up' data-aos-duration='2000'>
						...
						<div className='flex md:flex-col flex-col-reverse gap-4 md:mt-16 mt-8'>
							<div
								className='grid gap-11 md:grid-cols-3 grid-cols-1'
								data-aos='fade-right'
								data-aos-duration='2000'
							>
							...
							<p className='font-medium text-[#787878] text-sm text-center'>
								Designing all possible plans states and interractions
							</p>
						</div>
					</div>
					...
					<div>
						...
						<div data-aos='fade-up' data-aos-duration='2000'>
							...
							<p className='font-medium text-[#787878] text-sm text-center pt-4'>
								A summary of what the sample report contains
							</p>
						</div>
					</div>
					...
					<div>
						<div data-aos='fade-up' data-aos-duration='2000'>
							...
							<p className='font-medium text-[#787878] text-sm text-center pt-4'>
								Total distance covered and detects when the odometer is manipulated
							</p>
						</div>
					</div>
					...
					<div>
						<div data-aos='fade-up' data-aos-duration='2000'>
							...
							<p className='font-medium text-[#787878] text-sm text-center pt-4 pb-20'>
								Estimated market value and its breakdown{' '}
							</p>
						</div>
					</div>
				</div>
			...
			<section className='section'>
				...
				<div className='md:mt-12 mt-6'>
					...
					<p className='introduction font-bold max-w-[720px]'>
						Crafting the problem statements for our different levels of end-users and their journeys
					</p>
					<p className='textMediumBase'>
						Based on our initial user research, the <i>VIN Check</i> feature would most likely be used by vehicle
						owners and auto-technicians to gather information about a certain vehicle. We therefore not only had
						to consider only the direct users (vehicle owners), but also our users’s technicians (auto -
						technicians) as our end - users, with separate problem statement and challenges.
					</p>
				</div>
				<div className='flex md:flex-row flex-col my-16 md:gap-[70px] gap-8 '>
					<div className='flex flex-col gap-10 items-center justify-center w-full'>
						...
						<div className='bg-[#FAFAFA] rounded-md md:p-10 p-6'>
							<p className='text-base font-medium text-[#454545]'>
								<span className='text-[#F22E5D] font-semibold'>Vehicle Owners</span> are facing difficulties
								getting <span className='font-bold'>insights into vehicle’s history, </span>decisions in{' '}
								<span className='font-bold'>maintenance planning,</span> assessing{' '}
								<span className='font-bold'>resale value,</span> getting{' '}
								<span className='font-bold'>safety information, </span>avoiding{' '}
								<span className='font-bold'>fraud, and</span> getting support from{' '}
								<span className='font-bold'>insurance and warranty claims.</span>
							</p>
						</div>
					</div>
					...
					<div className='flex flex-col gap-10 items-center justify-center w-full'>
						...
						<div className='bg-[#FAFAFA] rounded-md md:p-10 p-6'>
							<p className='text-base font-medium text-[#454545]'>
								<span className='text-[#F22E5D] font-semibold'> Auto - technicians</span> needs vehicle report
								as it assists with
								<span className='font-bold'> diagnostics, </span>ensuring{' '}
								<span className='font-bold'>parts compatibility,</span> obtaining
								<span className='font-bold'>safety and recall information,</span> verifying{' '}
								<span className='font-bold'>vehicle history, </span> and for{' '}
				...
				<p className='text-base text-[#454545]'>
					Consequently, this gives rise to two distinct yet interrelated goals that we must take into account
				...
				<div className='bg-[#FAFAFA] md:py-10 md:px-14 p-6 md:mt-16 mt-8'>
					<p className='border-l border-[#454545] ps-7 introductionwithoutpadding font-semibold text-[#454545]'>
						{' '}
						<span className='text-[#F22E5D]'>VIN Check</span> empower vehicle owners to know the hidden history of
						any vehicle from manufacturing to date, and make informed decisions about their vehicle's maintenance,
						repairs, and resale value?
					</p>
				</div>
				...
				<div className='bg-[#FAFAFA] md:py-10 md:px-14 p-6 md:mt-16 mt-8'>
					<p className='border-l border-[#454545] ps-7 introductionwithoutpadding font-semibold text-[#454545]'>
						{' '}
						<span className='text-[#F22E5D]'>VIN Check</span> provide an accurate detailed information for auto
						technician to find, maintain, and repair their customers vehicles?
					</p>
				</div>
			</section>
			...
			<section className='section'>
				<div className='md:mt-12 mt-6'>
					...
					<p className='introduction font-bold max-w-[605px]'>
						Exploring user roles within personas to further define the scope of our MVP.
					</p>
					<p className='textMediumBase'>
						Moving into a team brainstorming session, we grouped and prioritised users needs in order of
						importance. We formed the project goals and transformed our goals into specific user tasks, enabling
						our engineering team to anticipate potential technical limitations associated with each proposed
						solution.
						<br /> <br />
						Moreover, this exercise facilitated the product team's brainstorming process by providing tangible
						design concepts as we progress into the ideation phase.
					</p>
				</div>
				...
				<div className='my-16 bg-[#4182E5] md:py-20 md:px-14 px-6 py-10 text-white'>
					<h1 className='text-center font-semibold md:text-3xl text-lg'>
						Examples of Records that the <span className='font-extrabold'>VIN check</span> will contain that meets
						user needs
					</h1>
					<div className='grid grid-cols-4 md:mt-16 mt-8 md:gap-20 gap-5'>
						...
						<div>
							...
							<p className='md:pt-4 pt-2 md:text-base text-xs'>
								I want to legally own multiple vehicles for my business
							</p>
						</div>
						<div>
							<h1 className='flex items-center md:text-base text-xs font-bold'>
					...
					<div className='grid grid-cols-4 md:mt-10 mt-6 md:gap-20 gap-5'>
						...
						<div>
							<p className='md:pt-4 pt-2 md:text-base text-xs'>
								When I need to maintain and repair my customer’s vehicle
							</p>
						</div>
						<div>
							<p className='md:pt-4 pt-2 md:text-base text-xs'>
								To easily repair vehicles with compatible parts and low cost.{' '}
							</p>
						</div>
						<div>
							<p className='md:pt-4 pt-2 md:text-base text-xs'>
								So I make informed decisions in repairs and maintenance.
							</p>
						</div>
					</div>
				</div>
			...
			<section className='bg-[#FAFAFA] section'>
				<div className=''>
					...
					<p className='introduction font-bold max-w-[605px]'>
						Maintaining ease of use and feasibility through careful consideration of integration.
					</p>
					<p className='textMediumBase'>
						Through the ideation phase, we placed high importance on accurate and comprehensive information,
						covering a wide range of vehicle makes, models, and years. Considering the pricing rate and managing
						online transactions globally.
						<br /> <br />
						We partnered with ClearVin so we have the ability to customise the VIN report unique to our brand.
						There are some key design considerations that were made to ensure that the interface is easily
						interpreted by both vehicle owners and auto-technicians. We valued our potential users and created
						ways on protecting their data.
					</p>
				</div>
				...
				<div className='grid md:grid-cols-2 grid-cols-1 md:mt-24 mt-8 gap-x-24 md:gap-y-16 gap-y-6 items-center'>
					<div className='text-center font-Fraunces font-bold text-[#787878] text-[26px]'>
						Some of our key solution goals are....
					</div>
					<div>
						...
						<p className='mt-7 text-base text-[#454545]'>
							Ensuring we have access to reliable and up-to-date databases, allowing for through checks of
							vehicle’s history to get relevant information.
						</p>
					</div>
					<div>
						<h1 className='flex items-center font-bold font-Fraunces text-[26px] leading-10'>
						...
						<p className='mt-7 text-base text-[#454545]'>
							Enabling foreign transactions, and placing a good balance between necessary functionalities and
							affordability by using per-check fees or subscription plans.
						</p>
					</div>
					<div>
						<h1 className='flex items-center font-bold font-Fraunces text-[26px] leading-10'>
						...
						<p className='mt-7 text-base text-[#454545]'>
							Considered whether the VIN Check solution can seamlessly integrate with our existing software. We
							chose a user - friendly interface to allow for easy interpretation.
						</p>
					</div>
				</div>

				<div
					className='font-medium text-[#787878] text-sm flex md:flex-col flex-col gap-4 mt-4'
					data-aos='fade-up'
					data-aos-duration='1500'
				>
					<Vin20 className='w-full h-full' />
					<p className='text-center introductionwithoutpadding'>
						Having considered the user's requirements and potential solutions, we proceeded to develop hypotheses
						that will enable us to evaluate the effectiveness of our proposed outcomes.
					</p>
				</div>
			</section>
			...
			<section className='section'>
				<div className='md:mt-12 mt-6'>
					<h2 className='text-xl font-semibold text-[#F22E5D]'>
						Analysing user flows into organised and structured approach{' '}
					</h2>
					<p className='introduction font-bold max-w-[605px]'>
						A product flow for both end-users, with an enhanced end-to-end experience.{' '}
					</p>
					<p className='textMediumBase'>
						To ensure that Trophie is able to provide a full, seamless, and robust experience, we had to identify
						and solutionise the touch-points where Trophie could empower our users to complete their goals, which
						was greatly assisted through our user jobs. This covers all the way from managers first getting
						informed about the new Sponsorship feature, to sponsors receiving their 'thank-you' receipt after
						their purchase.
					</p>
				</div>
				...
				<p className='text-base text-[#454545]'>
					With the active participation of our lead engineer during the mapping process, we efficiently improved
					our product architecture, resulting in a more streamlined user experience with fewer steps.
					<br /> <br />
			...
			<section className='section bg-[#FAFAFA]'>
				...
				<div className='md:mt-12 mt-6'>
					<p className='introduction text-center'>
						{' '}
						A reliable, efficient, and accessible platform that empowers users, such as{' '}
						<span className='font-bold'>auto technicians and vehicle owners, </span>to make informed decisions
						about their vehicles,{' '}
						<span className='font-bold'>
							by assessing the condition, safety, and value of a vehicle effectively
						</span>
						.
					</p>
					<p className='textMediumBase'>
					...
					<div className='border-2 border-dashed border-[#4183E5] flex items-start py-8 md:px-14 px-5 w-full md:gap-10 gap-4 mt-10'>
						<div>
							...
							<p className='md:text-base text-xs text-[#454545]'>
								{' '}
								Here is checkout screen designed for the mobile app.
							</p>
						</div>
						...
						<div>
							...
							<p className='md:text-base text-xs text-[#454545]'>
								{' '}
								The summary on the left displays information about the vehicle's history, while the cost is
								displayed on the right for easy reference.
							</p>
						</div>
					</div>
				</div>
			...
			<section className='section'>
				<div className='md:mt-12 mt-6'>
					...
					<p className='introduction font-bold max-w-[605px]'>
						Enabling a direct connection between vehicle’s history and their owners.
					</p>
					<p className='textMediumBase'>
						This direct connection empowers vehicle owners and auto technicians with valuable insights into their
						vehicle's past, providing them with the necessary information to make informed decisions and deliver
						efficient services.
					</p>
				</div>
				...
				<div className='md:mt-16 mt-8 grid md:grid-cols-3 grid-cols-1 gap-6 items-start'>
					<div className='h-full'>
						...
						<div className='border-l-8 border-[#F2F2F2] ps-5 md:mt-9 mt-4'>
							...
							<p className='text-base text-[#454545] '>
								VIN Check now offers increased global accessibility, allowing users from around the world to
								easily request and access the service.
							</p>
						</div>
					</div>
					<div className='h-full'>
						...
						<div className='border-l-8 border-[#F2F2F2] ps-5 md:mt-9 mt-4'>
							...
							<p className='text-base text-[#454545] '>
								VIN check has gained popularity among vehicle owners and auto technicians due to its transparent
								nature. As a result, more users are now utilising VIN check services.
							</p>
						</div>
					</div>
					<div className='h-full'>
						...
						<div className='border-l-8 border-[#F2F2F2] ps-5 md:mt-9 mt-4'>
							...
							<p className='text-base text-[#454545] '>
								The user flow in the web app served as a benchmark for improving the VIN Check feature in the
								mobile app, ensuring consistency and seamless usability across both platforms.
							</p>
						</div>
					</div>
				</div>
